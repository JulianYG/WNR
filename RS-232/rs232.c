...
#if defined(__linux__) || defined(__MACH__)   /* Linux & FreeBSD */
...
char comports[38][30]={"/dev/tty.usbmodem1411","/dev/ttyS1","/dev/ttyS2","/dev/ttyS3","/dev/ttyS4","/dev/ttyS5",
...
*/
  ...
  printf("%s", comports[comport_number]);
