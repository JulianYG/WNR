...
#include "app_error.h"
#include "nrf_gpio.h"
#include "nrf52_bitfields.h" // #CHANGE
#include "ble.h"
#include "ble_hci.h"
...
#define DEVICE_NAME                     "Nordic_TTest"                             /**< Name of device. Will be included in the advertising data. */
// #CHANGE end
...
#define APP_TIMER_MAX_TIMERS            (3 + BSP_APP_TIMERS_NUMBER)                 /**< Maximum number of simultaneously created timers. */   // #CHANGE
...
#define T_INTERVAL                      APP_TIMER_TICKS(100, APP_TIMER_PRESCALER) // #CHANGE
static app_timer_id_t                   m_app_id; /**< app timer ID. */    // #CHANGE
...
//    ble_debug_assert_handler(error_code, line_num, p_file_name);        // #CHANGE
...
static void sec_params_init(void)
{
    ...
    //m_sec_params.timeout      = SEC_PARAM_TIMEOUT; // #CHANGE added new
...
// # CHANGE start: retrieved from - https://github.com/NordicSemiconductor/nrf52-gtt-demos/blob/master/04c_nfc_pairing_ble/main.c
...
// #CHANGE added function completely from nrf51
    ...
    switch (p_ble_evt->header.evt_id)
    {
        ...
        case BLE_GAP_EVT_SEC_PARAMS_REQUEST:
            err_code = sd_ble_gap_sec_params_reply(m_conn_handle,
                                                   ...
                                                   &m_sec_params, NULL);            // #CHANGE
            APP_ERROR_CHECK(err_code);
            break;

        case BLE_GATTS_EVT_SYS_ATTR_MISSING:
            err_code = sd_ble_gatts_sys_attr_set(m_conn_handle, NULL, 0, 0); // #CHANGE
            APP_ERROR_CHECK(err_code);
            break;
        ...
        case BLE_GAP_EVT_SEC_INFO_REQUEST:
            ...
            else
            {
                ...
                err_code = sd_ble_gap_sec_info_reply(m_conn_handle, NULL, NULL, NULL);  // #CHANGE
                APP_ERROR_CHECK(err_code);
            }
            break;

        case BLE_GAP_EVT_TIMEOUT:
            if (p_ble_evt->evt.gap_evt.params.timeout.src == BLE_GAP_TIMEOUT_SRC_ADVERTISING)  // #CHANGE
            {
                nrf_gpio_pin_clear(ADVERTISING_LED_PIN_NO);

                // Configure buttons with sense level low as wakeup source.
                nrf_gpio_cfg_sense_input(WAKEUP_BUTTON_ID,
                                         BUTTON_PULL,
...
static void ble_stack_init(void)
{
    ...
    // #CHANGE this if statement not in old code
...
static void buttons_init(void)
{
    ...
    {
        {WAKEUP_BUTTON_ID, false, BUTTON_PULL, NULL},
        {LEDBUTTON_BUTTON_PIN_NO, false, BUTTON_PULL, button_event_handler}
    };

    app_button_init(buttons, sizeof(buttons) / sizeof(buttons[0]), BUTTON_DETECTION_DELAY);  // #CHANGE
		err_code = app_button_enable();
		APP_ERROR_CHECK(err_code);
}
