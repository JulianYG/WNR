...
#define TARGET_UUID                BLE_UUID_NUS_SERVICE                             /**< Target device name that application is looking for. */
...
{
	uint8_t  received_string[] = "Received\n";
...
static void services_init(void)
{
    ...
    err_code = ble_nus_init_disc(&m_nus, &nus_init);
    APP_ERROR_CHECK(err_code);
}
...
int main(void)
{
    ...
    // with devices that advertise Nordic Uart.
    scan_start();
