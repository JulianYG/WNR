...
uint32_t        m_enabled_users_mask;          /**< Mask for tracking which users are enabled. */  // #CHANGE
uint8_t         m_user_array_size;             /**< Size of user array. */                         // #CHANGE
uint8_t         m_user_count;                  /**< Number of registered users. */                 // #CHANGE
gpiote_user_t * mp_users = NULL;               /**< Array of GPIOTE users. */                      // #CHANGE
 ...
 */
void sense_level_toggle(gpiote_user_t * p_user, uint32_t pins) // #CHANGE
{
    uint32_t pin_no;
...
void sense_level_disable(uint32_t pins)  // #CHANGE
{
    uint32_t pin_no;
